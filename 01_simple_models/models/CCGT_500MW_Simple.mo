within ;
model CCGT_500MW_Simple "500MW Combined Cycle Gas Turbine - Simplified Model"
  ...
  // Gas turbine parameters SCALED FOR 500MW (x1.27)
  parameter SI.MassFlowRate m_air = 762 "Air mass flow rate [kg/s] (Scaled for 500MW)";
  ...
  parameter SI.MassFlowRate m_fuel_gas = 15.875 "Fuel mass flow [kg/s] (Scaled for 500MW)";
...
equation
  ...
  annotation (
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-200,-100},{200,100}}), graphics={
      ...
      Text(extent={{-200,-90},{200,-100}}, textString="500MW CCGT - Scaled Model", textStyle={TextStyle.Bold})}),
    
    Documentation(info="<html>
<h4>500MW Combined Cycle Gas Turbine Model</h4>

<p><b>System Overview:</b></p>
<p>This model is scaled to produce approximately 500MW of total power output, combining a gas turbine (Brayton cycle) with a steam turbine (Rankine cycle).</p>

<h4>Components:</h4>
<ol>
<li><b>Gas Turbine:</b> Scaled GE 9F-class equivalent, ~350 MW</li>
<li><b>HRSG:</b> Three-pressure level heat recovery</li>
<li><b>Steam Turbine:</b> ~150 MW additional power</li>
<li><b>Condenser:</b> 0.05 bar vacuum</li>
</ol>

<h4>Expected Performance:</h4>
<ul>
<li>Total Power: ~500 MW</li>
<li>Combined Efficiency: >60%</li>
</ul>
</html>"),
    
    experiment(StartTime=0, StopTime=1, Interval=1, Tolerance=1e-6));

end CCGT_500MW_Simple;
